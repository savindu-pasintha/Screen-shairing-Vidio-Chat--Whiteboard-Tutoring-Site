 ...
 /*--------------------------------------1--RTC communication---start---------------------------------------------------- */
    ...
    useEffect(() => {
        ...
        navigator.mediaDevices.getUserMedia({ video: true, audio: true }).then((stream) => {
            ...
            //
            myRecVideo.current.srcObject = stream;
  ...
  const startbuttonclick=async ()=> {
    ...
    return (
        <div >
            ...
            <div>
                <div>
                    <button onClick={recordButtonclick} id="record" >Start Recording</button>
                    <button onClick={playButtonclick} id="play" >Play</button>
                    <button onClick={downloadButtonclick} id="download" >Download</button>
                    <video id="leftVideo" ref={myRecVideo}  playsInline  muted  autoPlay controls style={{ width: "300px" }} />
                    <video id="rightVideo" playsInline  muted  autoPlay controls style={{ width: "300px" }} />
                </div>
